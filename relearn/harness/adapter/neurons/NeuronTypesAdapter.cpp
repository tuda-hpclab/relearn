...
void NeuronTypesAdapter::disable_neurons(size_t number_neurons, std::shared_ptr<NeuronsExtraInfo> extra_infos, std::mt19937& mt) {
...
void NeuronTypesAdapter::disable_neurons(size_t number_neurons, size_t number_disabled, const std::shared_ptr<NeuronsExtraInfo>& extra_infos, std::mt19937& mt) {
