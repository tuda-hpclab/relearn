...
public:
    ...
    static std::unordered_set<RankNeuronId> get_random_rank_neuron_ids(NeuronID::value_type number_neurons_per_rank, size_t num_ranks,
                                                                       NeuronID::value_type number_neurons_in_sample, std::mt19937& mt);
};
