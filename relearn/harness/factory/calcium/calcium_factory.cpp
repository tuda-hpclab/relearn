...
double CalciumFactory::get_random_beta(std::mt19937& mt) {
    const auto beta_distr = boost::random::uniform_real_distribution<double>(CalciumCalculator::min_beta, CalciumCalculator::max_beta);
    return beta_distr(mt);
}

double CalciumFactory::get_random_tau_C(std::mt19937& mt) {
    const auto tau_C_distr = boost::random::uniform_real_distribution<double>(CalciumCalculator::min_tau_C, CalciumCalculator::max_tau_C);
...
std::unique_ptr<CalciumCalculator> CalciumFactory::construct_calcium_calculator_no_decay(const double initial, const double target) {
...
std::unique_ptr<CalciumCalculator> CalciumFactory::construct_calcium_calculator_relative_decay(const double initial, const double target, const double decay_amount, const CalciumCalculator::step_type decay_step) {
...
std::unique_ptr<CalciumCalculator> CalciumFactory::construct_calcium_calculator_absolute_decay(const double initial, const double target, const double decay_amount, const CalciumCalculator::step_type decay_step) {
    auto decay_interval = utility::Interval<RelearnTypes::step_type>{ .begin = 0, .end = std::numeric_limits<utility::Interval<RelearnTypes::step_type>::step_type>::max(), .frequency = decay_step };
