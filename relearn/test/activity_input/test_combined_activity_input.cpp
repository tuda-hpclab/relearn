...
TEST_F(CombinedActivityInputTest, testConstructorNoThrow) {
    ...
    ASSERT_NO_THROW(std::ignore = CombinedActivityInput({}));
    ASSERT_NO_THROW(std::ignore = CombinedActivityInput({ constant_input_1 }));
    ASSERT_NO_THROW(std::ignore = CombinedActivityInput({ normal_input_1 }));
    ASSERT_NO_THROW(std::ignore = CombinedActivityInput({ constant_input_1, normal_input_1 }));
    ASSERT_NO_THROW(std::ignore = CombinedActivityInput({ constant_input_1, normal_input_1, constant_input_2, normal_input_2 }));
}
...
TEST_F(CombinedActivityInputTest, testConstructorThrow) {
    ...
    ASSERT_THROW_NO_PRINT(std::ignore = CombinedActivityInput({ empty_ptr }), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = CombinedActivityInput({ constant_input_1, empty_ptr }), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = CombinedActivityInput({ normal_input_1, empty_ptr }), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = CombinedActivityInput({ constant_input_1, empty_ptr, normal_input_1 }), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = CombinedActivityInput({ constant_input_1, normal_input_1, empty_ptr, constant_input_2, normal_input_2 }), RelearnException);

    const auto combined = std::make_shared<CombinedActivityInput>(std::vector<std::shared_ptr<ActivityInput>>{});
    const auto vec = std::vector<std::shared_ptr<ActivityInput>>{ empty_ptr, combined };
    ASSERT_THROW_NO_PRINT(std::ignore = CombinedActivityInput(vec), RelearnException);
}
...
TEST_F(CombinedActivityInputTest, testInitAndCreate) {
    ...
    auto combined_activity_input = CombinedActivityInput({ normal_input_2, constant_input_1, normal_input_1, constant_input_2 });
...
TEST_F(CombinedActivityInputTest, testUpdateInputAfterAdd) {
    ...
    auto other_combined_activity_input = std::make_shared<CombinedActivityInput>(vec);
