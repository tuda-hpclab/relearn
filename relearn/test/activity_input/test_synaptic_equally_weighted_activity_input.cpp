...
TEST_F(SynapticEquallyWeightedActivityInputTest, testConstructorThrow) {
    ...
    ASSERT_THROW_NO_PRINT(std::ignore = SynapticEquallyWeightedActivityInput(1, {}, 1.0), RelearnException);
}
...
TEST_F(SynapticEquallyWeightedActivityInputTest, testConstructorNoThrow) {
    ...
    ASSERT_NO_THROW(std::ignore = SynapticEquallyWeightedActivityInput(1, fired_status_comm, 1.0));
}
...
TEST_F(SynapticEquallyWeightedActivityInputTest, testInitAndCreate) {
    ...
    auto synaptic_activity_input = SynapticEquallyWeightedActivityInput(1, fired_status_comm, 1.0);
...
// The GPU variant iterates over the spikes not the edges. update_input_range is therefore not supported
TEST_F(SynapticEquallyWeightedActivityInputTest, testUpdateInputRangeFullNetworkGraph) {
    ...
    std::unique_ptr<ActivityInput> synaptic_activity_input = std::make_unique<SynapticEquallyWeightedActivityInput>(1, fired_status_comm, 1.0f);
