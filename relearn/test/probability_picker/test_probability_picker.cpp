...
TEST_F(ProbabilityPickerTest, testPickTargetKeyException) {
    ...
    ASSERT_THROW_NO_PRINT(std::ignore = ProbabilityPicker::pick_target(std::vector<double>{}, RandomHolderKey::SynapseDeletionFinder), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = ProbabilityPicker::pick_target(std::vector{ 0.0 }, RandomHolderKey::SynapseDeletionFinder), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = ProbabilityPicker::pick_target(std::vector{ 0.0, 0.0 }, RandomHolderKey::SynapseDeletionFinder), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = ProbabilityPicker::pick_target(std::vector{ 0.0, 0.0, -1.0 }, RandomHolderKey::SynapseDeletionFinder), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = ProbabilityPicker::pick_target(std::vector{ 0.0, 0.0, -1.0, 1.0 }, RandomHolderKey::SynapseDeletionFinder), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = ProbabilityPicker::pick_target(std::vector{ 2.0, 1.421, -1.0, 1.0 }, RandomHolderKey::SynapseDeletionFinder), RelearnException);
}
