...
TEST_F(GammaKernelTest, testConstruction) {
    ...
    ASSERT_NO_THROW(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(0.1), utility::as<attraction_type>(1.0)));
    ASSERT_NO_THROW(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(1.0), utility::as<attraction_type>(0.1)));
    ASSERT_NO_THROW(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(1.1), utility::as<attraction_type>(1.0)));

    ASSERT_NO_THROW(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(0.1), utility::as<attraction_type>(750.0)));
    ASSERT_NO_THROW(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(1.0), utility::as<attraction_type>(750.0)));
    ASSERT_NO_THROW(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(1.1), utility::as<attraction_type>(750.0)));
}
...
TEST_F(GammaKernelTest, testConstructionExceptions) {
    ...
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(0.1), utility::as<attraction_type>(0.0)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(0.0), utility::as<attraction_type>(0.0)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(1.1), utility::as<attraction_type>(0.0)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(-5.0), utility::as<attraction_type>(0.0)), RelearnException);

    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(0.1), utility::as<attraction_type>(-2.0)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(0.0), utility::as<attraction_type>(-2.0)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(1.1), utility::as<attraction_type>(-2.0)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(-5.0), utility::as<attraction_type>(-2.0)), RelearnException);

    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(0.0), utility::as<attraction_type>(0.1)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(0.0), utility::as<attraction_type>(0.0)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(0.0), utility::as<attraction_type>(1.1)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(0.0), utility::as<attraction_type>(5.0)), RelearnException);

    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(-2.0), utility::as<attraction_type>(0.1)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(-2.0), utility::as<attraction_type>(-0.0)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(-2.0), utility::as<attraction_type>(1.1)), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = GammaDistributionKernel(utility::as<attraction_type>(-2.0), utility::as<attraction_type>(-5.0)), RelearnException);
}
...
TEST_F(GammaKernelTest, testGetter) {
    ...
    auto kernel = GammaDistributionKernel{ utility::as<attraction_type>(8541.58), utility::as<attraction_type>(156478.587) };
    ASSERT_EQ(kernel.get_k(), utility::as<attraction_type>(8541.58));
    ASSERT_EQ(kernel.get_theta(), utility::as<attraction_type>(156478.587));
}
...
TEST_F(GammaKernelTest, testPositions) {
    ...
    const auto kernel = GammaDistributionKernel{ utility::as<attraction_type>(7.5), utility::as<attraction_type>(1.1) };
...
TEST_F(GammaKernelTest, testProbabilities) {
    ...
    const auto kernel = GammaDistributionKernel{ utility::as<attraction_type>(2.0), utility::as<attraction_type>(2.0) };
