...
TEST_F(AEIFModelTest, testDefaultParameters) {
    ...
    ASSERT_EQ(default_parameters.get_g_L(), param_type::default_g_L);
    ASSERT_EQ(default_parameters.get_E_L(), param_type::default_E_L);
    ASSERT_EQ(default_parameters.get_V_T(), param_type::default_V_T);
    ASSERT_EQ(default_parameters.get_d_T(), param_type::default_d_T);
    ASSERT_EQ(default_parameters.get_tau_w(), param_type::default_tau_w);
...
TEST_F(AEIFModelTest, testParameters) {
    if (mpiPP::MPIInfo::get_number_ranks() != 1) {
        if (mpiPP::MPIInfo::get_my_rank() == mpiPP::MPIRank::root_rank()) {
            std::cerr << "Test only works with 1 MPI ranks.\n";
        }
    ...
    ASSERT_EQ(parameters.get_E_L(), 3.0);
    ASSERT_EQ(parameters.get_V_T(), 4.0);
    ASSERT_EQ(parameters.get_d_T(), 5.0);
    ASSERT_EQ(parameters.get_tau_w(), 6.0);
    ASSERT_EQ(parameters.get_a(), 7.0);
    ASSERT_EQ(parameters.get_b(), 8.0);
    ASSERT_EQ(parameters.get_V_spike(), 9.0);
}

TEST_F(AEIFModelTest, testDefaultConstructorNoThrow) {
    if (mpiPP::MPIInfo::get_number_ranks() != 1) {
        if (mpiPP::MPIInfo::get_my_rank() == mpiPP::MPIRank::root_rank()) {
            std::cerr << "Test only works with 1 MPI ranks.\n";
        }
...
TEST_F(AEIFModelTest, testGetter) {
    if (mpiPP::MPIInfo::get_number_ranks() != 1) {
        if (mpiPP::MPIInfo::get_my_rank() == mpiPP::MPIRank::root_rank()) {
            std::cerr << "Test only works with 1 MPI ranks.\n";
        }
    ...
    ASSERT_EQ(model.get_model_parameters().get_g_L(), g_L);
    ASSERT_EQ(model.get_model_parameters().get_E_L(), E_L);
    ASSERT_EQ(model.get_model_parameters().get_V_T(), V_T);
    ASSERT_EQ(model.get_model_parameters().get_d_T(), d_T);
    ASSERT_EQ(model.get_model_parameters().get_tau_w(), tau_w);
...
TEST_F(AEIFModelTest, testConstructorThrow) {
    if (mpiPP::MPIInfo::get_number_ranks() != 1) {
        if (mpiPP::MPIInfo::get_my_rank() == mpiPP::MPIRank::root_rank()) {
            std::cerr << "Test only works with 1 MPI ranks.\n";
        }
    ...
    ASSERT_THROW_NO_PRINT(std::ignore = models::AEIFModel(0, activity_input, fired_status_comm, parameters), RelearnException);
    ASSERT_THROW_NO_PRINT(std::ignore = models::AEIFModel(h, activity_input, fired_status_comm_empty, parameters), RelearnException);
...
TEST_F(AEIFModelTest, testUpdateConstantInput) {
    if (mpiPP::MPIInfo::get_number_ranks() != 1) {
        if (mpiPP::MPIInfo::get_my_rank() == mpiPP::MPIRank::root_rank()) {
            std::cerr << "Test only works with 1 MPI ranks.\n";
        }
...
TEST_F(AEIFModelTest, testUpdateNormalInput) {
    if (mpiPP::MPIInfo::get_number_ranks() != 1) {
        if (mpiPP::MPIInfo::get_my_rank() == mpiPP::MPIRank::root_rank()) {
            std::cerr << "Test only works with 1 MPI ranks.\n";
        }
...
TEST_F(AEIFModelTest, testMultipleUpdates) {
    if (mpiPP::MPIInfo::get_number_ranks() != 1) {
        if (mpiPP::MPIInfo::get_my_rank() == mpiPP::MPIRank::root_rank()) {
            std::cerr << "Test only works with 1 MPI ranks.\n";
        }
...
TEST_F(AEIFModelTest, testBenchmarkFunctionality) {
    if (mpiPP::MPIInfo::get_number_ranks() != 1) {
        if (mpiPP::MPIInfo::get_my_rank() == mpiPP::MPIRank::root_rank()) {
            std::cerr << "Test only works with 1 MPI ranks.\n";
        }
