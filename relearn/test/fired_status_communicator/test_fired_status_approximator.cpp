...
TEST_F(FiredStatusApproximatorTest, testConstructorThrow) {
    ...
    ASSERT_THROW_NO_PRINT(FiredStatusApproximator fsa(0), RelearnException);
    ASSERT_THROW_NO_PRINT(FiredStatusApproximator fsa(-1), RelearnException);
    ASSERT_THROW_NO_PRINT(FiredStatusApproximator fsa(-4), RelearnException);
}
...
TEST_F(FiredStatusApproximatorTest, testConstructorNoThrow) {
    ...
    ASSERT_NO_THROW(FiredStatusApproximator fsa(1));
    ASSERT_NO_THROW(FiredStatusApproximator fsa(2));
    ASSERT_NO_THROW(FiredStatusApproximator fsa(4));
    ASSERT_NO_THROW(FiredStatusApproximator fsa(8));
    ASSERT_NO_THROW(FiredStatusApproximator fsa(16));
    ASSERT_NO_THROW(FiredStatusApproximator fsa(32));
    ASSERT_NO_THROW(FiredStatusApproximator fsa(64));
    ASSERT_NO_THROW(FiredStatusApproximator fsa(128));
}
...
TEST_F(FiredStatusApproximatorTest, testGetNumberRanks) {
    ...
    const auto fsa_1 = FiredStatusApproximator(1);
    ASSERT_EQ(fsa_1.get_number_ranks(), 1);

    const auto fsa_2 = FiredStatusApproximator(2);
    ASSERT_EQ(fsa_2.get_number_ranks(), 2);

    const auto fsa_4 = FiredStatusApproximator(4);
    ASSERT_EQ(fsa_4.get_number_ranks(), 4);

    const auto fsa_8 = FiredStatusApproximator(8);
    ASSERT_EQ(fsa_8.get_number_ranks(), 8);

    const auto fsa_16 = FiredStatusApproximator(16);
    ASSERT_EQ(fsa_16.get_number_ranks(), 16);

    const auto fsa_32 = FiredStatusApproximator(32);
    ASSERT_EQ(fsa_32.get_number_ranks(), 32);

    const auto fsa_64 = FiredStatusApproximator(64);
    ASSERT_EQ(fsa_64.get_number_ranks(), 64);

    const auto fsa_128 = FiredStatusApproximator(128);
...
TEST_F(FiredStatusApproximatorTest, testInitAndCreate) {
    ...
    auto fsa = FiredStatusApproximator(1);
...
TEST_F(FiredStatusApproximatorTest, testContainsThrow4) {
    ...
    auto fsa = FiredStatusApproximator(4);
