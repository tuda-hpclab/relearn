...
TEST_F(SynapticElementsIOTest, testRead) {
    ...
    const auto& functions = SynapticElementsIO::load_function_from_file("io0.tmp", mpiPP::MPIRank::root_rank(), local_group_translator);
...
TEST_F(SynapticElementsIOTest, testReadDefault) {
    ...
    const auto& functions = SynapticElementsIO::load_function_from_file("io1.tmp", my_rank, local_group_translator);
...
TEST_F(SynapticElementsIOTest, testReadGroupNames) {
    ...
    const auto& functions = SynapticElementsIO::load_function_from_file("io2.tmp", my_rank, local_group_translator);
