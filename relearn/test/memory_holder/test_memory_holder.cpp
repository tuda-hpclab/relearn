...
//
//
//     memory_holder->init(1024);
//     const auto& span_memory = memory_holder->get_current_memory();
...
//
//
//     memory_holder->init(9 * Constants::number_oct);
//
//     auto& memory = memory_holder->get_current_memory();
//
//     auto root = OctreeNode<AdditionalCellAttributes>{};
//
//     const auto indices = ranges::views::iota(0U, Constants::number_oct) | ranges::to_vector | actions::shuffle(this->mt);
...
//     memory_holder->init(cells.size());
//
//     memory_holder->init(128 * Constants::number_oct);
//
