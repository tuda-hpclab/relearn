...
std::vector<AlgorithmConfig::attraction_type> AlgorithmConfig::get_kernel_parameters(const KernelType kernel_type) const {
    switch (kernel_type) {
    case KernelType::Gamma: {
...
bool AlgorithmConfig::check_parameters_default(const std::vector<attraction_type>& parameters, const KernelType kernel_type) const {
    switch (kernel_type) {
    case KernelType::Gamma: {
...
std::string AlgorithmConfig::kernel_parameters_to_string(const std::vector<attraction_type>& parameters) const {
