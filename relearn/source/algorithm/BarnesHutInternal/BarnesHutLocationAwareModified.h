 ...
 * It is location-aware and outsources the initial probability calculation as well.
 * It is strongly tied to Octree, and performs MPI communication. The minimization of communication is the goal of this modified version.
 */
class BarnesHutLocationAwareModified : public ForwardCPUAlgorithm<DistantNeuronRequest, DistantNeuronResponse>, private OctreeAlgorithm<BarnesHutCell> {
public:
     ...
     */
    BarnesHutLocationAwareModified(const RelearnTypes::bounding_box_type& bounding_box, std::shared_ptr<SpaceFillingCurve> _space_filling_curve,
    ...
    ~BarnesHutLocationAwareModified() override = default;

    BarnesHutLocationAwareModified(const BarnesHutLocationAwareModified&) = delete;
    BarnesHutLocationAwareModified& operator=(const BarnesHutLocationAwareModified&) = delete;
    BarnesHutLocationAwareModified(BarnesHutLocationAwareModified&&) = default;
    BarnesHutLocationAwareModified& operator=(BarnesHutLocationAwareModified&&) = default;
    ...
    void record_memory_footprint(const std::unique_ptr<utility::MemoryFootprint>& footprint) override {
        ...
        footprint->emplace("BarnesHutLocationAwareModified", my_footprint);
...
protected:
    ...
    process_requests(const RelearnTypes::comm_map_creation<DistantNeuronRequest>& creation_requests) override;

    [[nodiscard]] PlasticDistantOutSynapses process_responses(const RelearnTypes::comm_map_creation<DistantNeuronRequest>& creation_requests, const RelearnTypes::comm_map_creation<DistantNeuronResponse>& creation_responses) override;
