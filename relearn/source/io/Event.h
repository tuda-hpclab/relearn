...
public:
     ...
     */
    static Event create_duration_begin_event(std::string&& name, std::set<EventCategory>&& categories,                                                                                             // NOLINT(cppcoreguidelines-rvalue-reference-param-not-moved) - moved into the returned Event below
                                             const double tracing_clock, const std::uint64_t process_id, const std::uint64_t thread_id, std::vector<std::pair<std::string, std::string>>&& args) { // NOLINT(cppcoreguidelines-rvalue-reference-param-not-moved)
     ...
     * @return The created object that can be printed using operator<<
     */
    static Event create_complete_event(std::string&& name, std::set<EventCategory>&& categories, const double duration,                                                                      // NOLINT(cppcoreguidelines-rvalue-reference-param-not-moved) - moved into the returned Event below
                                       const double tracing_clock, const std::uint64_t process_id, const std::uint64_t thread_id, std::vector<std::pair<std::string, std::string>>&& args) { // NOLINT(cppcoreguidelines-rvalue-reference-param-not-moved)
     ...
     * @return The created object that can be printed using operator<<
     */
    static Event create_instant_event(std::string&& name, std::set<EventCategory>&& categories, const InstantEventScope scope,                                                              // NOLINT(cppcoreguidelines-rvalue-reference-param-not-moved) - moved into the returned Event below
                                      const double tracing_clock, const std::uint64_t process_id, const std::uint64_t thread_id, std::vector<std::pair<std::string, std::string>>&& args) { // NOLINT(cppcoreguidelines-rvalue-reference-param-not-moved)
     ...
     * @return The created object that can be printed using operator<<
     */
    static Event create_counter_event(std::string&& name, std::set<EventCategory>&& categories,                                                                                             // NOLINT(cppcoreguidelines-rvalue-reference-param-not-moved) - moved into the returned Event below
                                      const double tracing_clock, const std::uint64_t process_id, const std::uint64_t thread_id, std::vector<std::pair<std::string, std::string>>&& args) { // NOLINT(cppcoreguidelines-rvalue-reference-param-not-moved)
