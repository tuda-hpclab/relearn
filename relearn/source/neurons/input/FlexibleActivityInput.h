 ...
 */
class FlexibleActivityInput : public ActivityInput {
public:
     ...
     */
    FlexibleActivityInput(std::vector<std::shared_ptr<ActivityInput>> inputs, std::unique_ptr<ChoiceFunction> choice_function)
    ...
    FlexibleActivityInput(const FlexibleActivityInput&) = delete;
    FlexibleActivityInput& operator=(const FlexibleActivityInput&) = delete;

    FlexibleActivityInput(FlexibleActivityInput&&) = default;
    FlexibleActivityInput& operator=(FlexibleActivityInput&&) = default;

    ~FlexibleActivityInput() override = default;
