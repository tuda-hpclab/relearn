...
#include "AbsoluteDecayCalciumCalculator.h"
...
void AbsoluteDecayCalciumCalculator::record_memory_footprint(const std::unique_ptr<utility::MemoryFootprint>& footprint) {
...
void AbsoluteDecayCalciumCalculator::update_target_calcium(const step_type step) noexcept {
