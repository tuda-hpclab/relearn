 ...
 */
class AbsoluteDecayCalciumCalculator : public CalciumCalculator {
public:
     ...
     */
    AbsoluteDecayCalciumCalculator(const double _decay_amount, const utility::Interval<step_type>& _decay_interval)
