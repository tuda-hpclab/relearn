...
public:
     ...
     */
    SynapticElements(std::shared_ptr<Axons> _axons, std::shared_ptr<Dendrites> _dendrites)
    ...
    virtual ~SynapticElements() = default;
     ...
     */
    void set_grown_elements_calculator(std::function<double(number_neurons_type)> calculator, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     * @exception Throws a RelearnException if calculator is empty
     */
    void set_delta_since_last_update_calculator(std::function<double(number_neurons_type)> calculator, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     * @exception Throws a RelearnException if calculator is empty
     */
    void set_connected_elements_calculator(std::function<unsigned int(number_neurons_type)> calculator, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     * @exception Throws a RelearnException if calculator is empty
     */
    void set_vacant_retract_ratio_calculator(std::function<double(number_neurons_type)> calculator, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     * @exception Throws a RelearnException if calculator is empty
     */
    void set_minimum_calcium_calculator(std::function<double(number_neurons_type)> calculator, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    void update_number_elements(step_type current_step, std::span<const double> calcium, std::span<const double> target_calcium);
     ...
     */
    void add_to_delta(const double delta, const number_neurons_type neuron_id, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    void add_to_delta(const std::span<const double> deltas, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     * @exception Throws a RelearnException if neuron_id is too large
     */
    void add_connected_elements(const unsigned int newly_added, const number_neurons_type neuron_id, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    void add_connected_elements(const std::span<const unsigned int> changes, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    void remove_connected_elements(const unsigned int newly_free, const number_neurons_type neuron_id, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    void remove_connected_elements(const std::span<const unsigned int> changes, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    void connect_elements(const unsigned int newly_connected, const number_neurons_type neuron_id, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    void connect_elements(const std::span<const unsigned int> changes, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    void disconnect_elements(const unsigned int newly_disconnected, const number_neurons_type neuron_id, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    void disconnect_elements(const std::span<const unsigned int> changes, const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    [[nodiscard]] std::vector<unsigned int> commit_updates(const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    [[nodiscard]] double get_total_additions(const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    [[nodiscard]] double get_total_deletions(const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    [[nodiscard]] std::span<const double> get_grown_elements(const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    [[nodiscard]] std::span<const double> get_deltas(const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    [[nodiscard]] std::span<const unsigned int> get_vacant_elements(const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    [[nodiscard]] std::span<const unsigned int> get_connected_elements(const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    [[nodiscard]] std::span<const double> get_vacant_retract_ratio(const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
     ...
     */
    [[nodiscard]] std::span<const double> get_minimum_calcium(const SynapticElementType synaptic_element_type) {
        const auto element_type = get_element_type(synaptic_element_type);
    ...
    static constexpr double default_nu{ 1e-4 };               // In Sebastian's work: 1e-5
    ...
    static constexpr double default_min_elements{ 0.0 };
    static constexpr double default_max_elements{ std::numeric_limits<double>::max() };
