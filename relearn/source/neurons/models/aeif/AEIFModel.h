...
public:
     ...
     */
    [[nodiscard]] const models::aeif::Parameters<double>& get_model_parameters() const noexcept {
        return parameters;
    }
...
private:
    std::vector<double, RelearnAllocator<double>> w{}; // adaption variable

    models::aeif::Parameters<double> parameters{};
};
